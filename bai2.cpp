...
int chuyenDiaThapHaNoi(int n, char cotNguon, char cotTrungGian, char cotDich); // n : dia
...
void xuatNguocCacChuSo(int n) {
    ...
    printf("So sau khi nghich dao : %d", nghichDao);
}
...
// tỉnh tổng các phần tử lẻ của mảng
// tìm max của các phân tử trong mangr
// tìm min của các phần tử trong mảng
// tìm ước số chung lớn nhất
// tìm ước số của 2 số dương
// đảo ngược chuỗi 
// xuất các chữ số 
...
int tichCacSoLe(int n) {
    ...
    printf("tinh tich cua cac so le =" );
    return tich;
}
